...
using static HW10.Infrastructure.Constants.Dictionaries;
using static HW10.Infrastructure.Enums.Operations;

namespace HW10.Infrastructure.Extentions
{
    public static class ExpressionCalculatorExtentions
    {
        ...
        {
            expression = default;
            if (!str.CheckValidness() || !str.TrySplit(out var elements)) 
                return false;
